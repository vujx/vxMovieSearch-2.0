...
class ObserverActionDetails {
    ...
    fun bind(
        viewModelDetails: MovieDetailViewModel,
        ...
        viewModelDetails.moviesObserver.observe(activity, {
            ...
            if (it.pictureURL != "N/A")
                Glide.with(activity)
                    .load(it.pictureURL)
                    .skipMemoryCache(false)
                    .placeholder(R.drawable.no_image_available)
                    .into(binding.ivMovie)
            else binding.ivMovie.setBackgroundResource(R.drawable.no_image_available)

            if (checkFirstTime) {
                activity.clickListener()
